...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<ul id="portfolio-filter">
		...
		$arraycat[$item->categoryalias] = $item->categoryname;
		endforeach; ?>
		<?php 
		$resultcat = array_unique($arraycat);
		?>
		<?php foreach ($resultcat as $key=>$cat):	?>
		<li><a data-filter=".<?php echo $key; ?>" href="#"><?php echo $cat; ?></a></li>
		<?php endforeach; ?>
	</ul>
	
  <ul class="projects-grid">
    <?php foreach ($items as $key=>$item):	?>
    <li class="<?php echo $item->categoryalias; ?> project-item <?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
	  ...
	  <?php if($params->get('itemTitle') || $params->get('itemCategory')): ?>
	  <div class="project-title">
		  <?php if($params->get('itemCategory')): ?>
		  <span class="moduleItemCategory"><?php echo $item->categoryname; ?></span>
		  <?php endif; ?>
