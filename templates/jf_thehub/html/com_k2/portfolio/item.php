...
<div id="k2Container" class="itemViewProject itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader itemHeaderProject">

	<?php if($this->item->params->get('itemDateCreated')): ?>
	<!-- Date created -->
	<span class="itemDateCreated">
		<?php echo JHTML::_('date', $this->item->created , JText::_('TPL_JF_THEHUB_K2_DATE_FORMAT')); ?>
	</span>
	<?php endif; ?>
	...
	<div class="itemLinks">
		...
		<div class="itemCategory">
			<span><?php echo JText::_('TPL_JF_THEHUB_K2_CATEGORY'); ?></span>
